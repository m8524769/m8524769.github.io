...
大概是在大一的时候，我便从网上了解到了渐进式 Web 应用这个东西，
通过在 Chrome 中将 Web 添加到安卓主屏幕的方式来模拟原生应用。
...
天呐！这简直酷毙了！那以后安卓应用和 Web 岂不统一了？这实在令人兴奋。
虽然那时候很少有公司在做这个，只有寥寥几个印度的互联网企业。
但我感觉这玩意儿绝对是颠覆性的，Google 也在强推这个。

只不过那时候我专业知识还不够，这在我眼中也就算个牛逼的黑科技罢了，望而生畏的那种。

到后来，我开始着手自己的博客，由于想要实现某种功能而接触了 [CacheStorage](https://developer.mozilla.org/en-US/docs/Web/API/CacheStorage)，
...
而 PWA 便是在此基础之上往移动端的扩展，甚至媲美原生应用，体验极佳。
